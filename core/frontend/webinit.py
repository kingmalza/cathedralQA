...
def create1(t_tenant,t_name, u_email):
    ...
    print('Pass is: ',auth_pass,' Email is: ',auth_email)
...
def create2(t_tenant,paid=0.49):
    ...
    try:
        send_html_email(auth_email, 'Get started with Aida', 'email.html', context, sender='wepredict@cathedral.ai')
        print("Email send")
    except Exception as e:
        print(e)
